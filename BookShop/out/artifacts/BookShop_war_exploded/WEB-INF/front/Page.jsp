...
<div class="page-bar">
    <ul class="page-num-ul clearfix">
        ...
        <c:if test="${param.currentPageNo > 1}">
            ...
            <a href="javascript:page_nav(document.forms[1],${param.currentPageNo-1});">上一页</a>
        </c:if>
        <c:if test="${param.currentPageNo < param.totalPageCount}">
            <a href="javascript:page_nav(document.forms[1],${param.currentPageNo+1});">下一页</a>
            <a href="javascript:page_nav(document.forms[1],${param.totalPageCount});">最后一页</a>
        </c:if>
        &nbsp;&nbsp;
    </ul>
